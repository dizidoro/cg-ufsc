...
public class BSpline extends Geometry {

	private static int curveCount = 1;

	List<Coordinate> coordinates;

	public BSpline(List<Coordinate> coordinates, Color color) {
		super("bSpline" + curveCount, Geometry.Type.BSPLINE, color);

		this.coordinates = coordinates;
		curveCount++;
	}

	private BSpline(String name, List<Coordinate> coordinates, Color color) {
		super(name, Geometry.Type.BSPLINE, color);
		this.coordinates = coordinates;
	}
	...
	public Geometry getWindowViewportTransformation(Window window,
		...
		return new BSpline(this.getName(), viewportCoordinates, this.getColor());
	}
