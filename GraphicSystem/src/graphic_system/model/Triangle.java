...
public class Triangle extends Geometry {
	...
	public Triangle(List<Coordinate> vertices, Color color) {
		super("triangle" + triangleCount, Geometry.Type.TRIANGLE, color);

		this.vertices = vertices;
		triangleCount++;
	}

	private Triangle(String name, List<Coordinate> vertices, Color color) {
		super(name, Geometry.Type.TRIANGLE, color);
		this.vertices = vertices;
	}
	...
	@Override
	public Triangle getWindowViewportTransformation(Window window,
			Viewport viewport) {
		...
		return new Triangle(this.getName(), viewportVertices, this.getColor());
	}
	...
	protected Geometry getTransformed(double[][] transformationMatrix) {
		...
		return new Triangle(name, transformedVertices, color);
	}
